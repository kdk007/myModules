...
var TouchSlide = function (a) {
    ...
    "leftLoop" == i && (P += 2, m.appendChild(m.children[0].cloneNode(!0)), m.insertBefore(m.children[n - 1].cloneNode(!0), m.children[0])), N = e(m, '<div class="tempWrap" style=" position:relative;"></div>'), m.style.cssText = "width:" + P * M + "px;" + "position:relative;padding:0;margin:0;";
